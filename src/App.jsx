  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 h-screen p-3 flex flex-col justify-center items-center">
      <form
        ...
        className="w-full md:w-3/4 lg:w-2/3 xl:w-1/2 text-center rounded-lg shadow-lg bg-white py-6 px-4 transition-all duration-500 transform hover:scale-105"
      >
      ...
      <div className="w-full md:w-3/4 lg:w-2/3 xl:w-1/2 text-center rounded-lg bg-white my-4 shadow-lg transition-all duration-500 transform hover:scale-105 max-h-[500px] overflow-auto">
